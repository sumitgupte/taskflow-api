...
**You are on branch `exercise-2` — Exercise 2: Vibe code a feature without instructions**

Your handout: [docs/exercises/exercise-2.md](docs/exercises/exercise-2.md)

This branch contains only what Exercise 2 needs. The handouts and
...
```bash
git add -A && git commit -m "ex2: my work"
