...
**You are on branch `exercise-3` — Exercise 3: Implementing a feature ad-hoc with instructions**

Your handout: [docs/exercises/exercise-3.md](docs/exercises/exercise-3.md)

This branch contains only what Exercise 3 needs. The handouts and
...
```bash
git add -A && git commit -m "ex3: my work"
